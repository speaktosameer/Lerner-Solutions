            ...
            <div className="container">
                ...
                <div className="section-wrapper">
                                ...
                                <div className="instructor-item">
                                    ...
                                    <div className="instructor-footer">
                                        <ul className="lab-ul d-flex flex-wrap justify-content-between align-items-center">
                                            ...
                                            <li><i className="icofont-linkedin">{val.linkedin}</i></li>
                                            <li><i className="icofont-facebook">{val.facebook}</i></li>
                                            <li><i className="icofont-instagram">{val.instagram}</i></li>
                                            <li><i className="icofont-twitter">{val.twitter}</i></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="text-center footer-btn">
                        <p>Want to help people learn, grow and achieve more in life?<Link to="#">Become an instructor</Link></p>
                    </div>
                </div>
            </div>
        </div>
